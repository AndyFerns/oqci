...
//!   [`GateKind`].
//! - [`param`] — [`Param`], a gate parameter that is either a concrete angle
//!   or a symbolic placeholder (Stage F).
//! - [`bind`] — [`bind_parameters`], the explicit symbolic → concrete step
//!   that must precede lowering.
